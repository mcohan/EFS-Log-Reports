use utf8;
package EFS::Log::Reports::Schema::DB::Result::InstallCellstate;
...
=head1 TABLE: C<install_cellstate>

=cut

__PACKAGE__->table("install_cellstate");
...
=head2 C<install_cellstate_idx1>
...
__PACKAGE__->add_unique_constraint("install_cellstate_idx1", ["install", "cell"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VFyd66uAwl4eGKsb+Z1VYQ
