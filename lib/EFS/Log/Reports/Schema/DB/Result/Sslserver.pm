use utf8;
package EFS::Log::Reports::Schema::DB::Result::Sslserver;
...
=head1 TABLE: C<sslserver>

=cut

__PACKAGE__->table("sslserver");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yfpzUjsQ01yUF4KPvGz45A
