use utf8;
package EFS::Log::Reports::Schema::DB::Result::LocationAttr;
...
__PACKAGE__->add_unique_constraint("location_attrs_idx1", ["location", "name"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:651GzXdaM48IuXoDko3M4A
