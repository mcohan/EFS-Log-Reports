use utf8;
package EFS::Log::Reports::Schema::DB::Result::Region;
...
__PACKAGE__->add_unique_constraint("region_idx1", ["name"]);
...
Related object: L<EFS::Log::Reports::Schema::DB::Result::RegionAttr>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2wJy7mTm6lafIixtjoATrw
